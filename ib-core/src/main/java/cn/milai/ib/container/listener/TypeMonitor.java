 ...
 * @date 2021.02.10
 */
public class TypeMonitor<T extends IBObject> extends ContainerMonitor {

	private TypeMonitor(Container container, Class<T> clazz) {
		super(container, o -> clazz.isInstance(o));
	}

	public static <T extends IBObject> TypeMonitor<T> monitor(LifecycleContainer container, Class<T> clazz) {
