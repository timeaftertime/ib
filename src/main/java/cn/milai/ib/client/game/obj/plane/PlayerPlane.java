...
import cn.milai.ib.client.game.obj.bullet.factory.NormalBulletFactory;
...
public class PlayerPlane extends Plane implements KeyboardListener {
	...
	public PlayerPlane(int x, int y, GameForm container) {
		super(x, y, BattleConf.PLAYER_WIDTH, BattleConf.PLAYER_HEIGHT, 0, 0, BattleConf.PLAYER_INIT_MAX_BULLENT,
				BattleConf.PLAYER_INIT_LIFE, Camp.PLAYER, ImageConf.PLAYER, container);
